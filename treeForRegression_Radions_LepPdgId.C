...
void treeForRegression_Radions_LepPdgId()
{
...
//	 V_v6-v1/171120_094251/0000/
        std::string inputfilename="/eos/uscms/store/user/lgiannin/Radions_highPt.root";//"/uscms_data/d3/cvernier/optimizationRegression/RegressionHbb/newTT.root";///eos/uscms/store/user/lpchbb/HeppyNtuples/V25/ZH_HToBB_ZToLL.root";//allgrav.root";//ttbar-g-25.root";
///eos/uscms/store/group/lpchbb/HeppyNtuples/V21/ZH_HToBB_ZToLL_M125_13TeV_powheg_pythia8.root";
	...
	TFile *outfile=new TFile("/eos/uscms/store/user/lgiannin/Processed_noRawPt_highPt.root", "recreate");
	int Jet_vtxNtrk;
	float nPVs_=-999;
