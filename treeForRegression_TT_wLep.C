...
void treeForRegression_TT_wLep()
{
...
///eos/uscms/store/group/lpchbb/HeppyNtuples/V21/ZH_HToBB_ZToLL_M125_13TeV_powheg_pythia8.root";
	...
	TFile *outfile=new TFile("/eos/uscms/store/user/lgiannin/Processed_TTbar_new.root", "recreate");
	int Jet_vtxNtrk;
	float nPVs_=-999;
